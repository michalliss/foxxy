...
object external {
  ...
  def tapir = Agg(
    ivy"com.softwaremill.sttp.tapir::tapir-core:1.11.6",
    ivy"com.softwaremill.sttp.tapir::tapir-json-zio:1.11.6"
  )
  ...
  def tapirServer = Agg(
    ivy"com.softwaremill.sttp.tapir::tapir-http4s-server-zio:1.11.6",
    ivy"com.softwaremill.sttp.tapir::tapir-swagger-ui-bundle:1.11.6"
  )
  ...
  def flyway = Agg(
    ivy"org.flywaydb:flyway-core:10.18.2",
    ivy"org.flywaydb:flyway-database-postgresql:10.18.2"
  )
  ...
  def frontend = zio_js ++ Agg(
    ivy"com.softwaremill.sttp.tapir::tapir-sttp-client::1.11.6",

...
object external {
  ...
  def tapir = Agg(
    ...
    ivy"com.softwaremill.sttp.tapir::tapir-json-zio:1.11.12"
  )
  ...
  def tapirServer = Agg(
    ivy"com.softwaremill.sttp.tapir::tapir-http4s-server-zio:1.11.12",
  ...
  def frontend = zio_js ++ Agg(
    ...
    ivy"com.softwaremill.sttp.tapir::tapir-sttp-client::1.11.12",

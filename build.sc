...
object external {
  ...
  def tapir = Agg(
    ivy"com.softwaremill.sttp.tapir::tapir-core:1.11.15",
    ivy"com.softwaremill.sttp.tapir::tapir-json-zio:1.11.15"
  )
  ...
  def tapirServer = Agg(
    ivy"com.softwaremill.sttp.tapir::tapir-http4s-server-zio:1.11.15",
    ivy"com.softwaremill.sttp.tapir::tapir-swagger-ui-bundle:1.11.15"
  )
  ...
  def frontend = zio_js ++ Agg(
    ...
    ivy"com.softwaremill.sttp.tapir::tapir-sttp-client::1.11.15",
